...
#node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 5

#node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 6

#node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 7

#node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 8

#node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 9
...
node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 26

node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 27

node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 28

node --max-old-space-size=2408000 build/src/index.js Moment/moment.json null null 29