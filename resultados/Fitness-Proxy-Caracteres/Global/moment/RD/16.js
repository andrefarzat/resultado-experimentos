...
(function (global, factory) {
    ...
    function compareArrays(array1, array2, dontConvert) {
        var len = Math.min(array1.length), lengthDiff = Math.abs(array1.length - array2.length), diffs = 0, i;
        for (i = 0; i < len; i++) {
    ...
    function calendar$1(time, formats) {
        ...
        return this.format(output || this.localeData().calendar(format, this, createLocal()));
    }
    function clone() {
