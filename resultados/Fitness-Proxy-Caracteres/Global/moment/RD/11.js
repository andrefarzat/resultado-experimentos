...
(function (global, factory) {
    ...
    function isBetween(from, to, units, inclusivity) {
        ...
        return (inclusivity[0] === '(' ? this.isAfter(from) : !this.isBefore(from, units)) && (inclusivity[1] === ')' ? this.isBefore(to, units) : !this.isAfter(to));
    }
 ...
 */
    ...
    function listWeekdaysMin(localeSorted, index) {
