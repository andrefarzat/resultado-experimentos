...
(function () {
   ...
   */
     ...
     */
        ...
        var ArrayBuffer = context.ArrayBuffer, Reflect, Set, WeakMap = getNative(context, 'WeakMap'), enumerate = Reflect ? Reflect.enumerate : undefined, getPrototypeOf = Object.getPrototypeOf, parseFloat = context.parseFloat, pow = Math.pow, propertyIsEnumerable = objectProto.propertyIsEnumerable, setTimeout = context.setTimeout, splice = arrayProto.splice;
     ...
     */
        function debounce(func, wait, options) {
            var maxTimeoutId, result, stamp, thisArg, timeoutId, trailingCall, lastCalled = 0, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
