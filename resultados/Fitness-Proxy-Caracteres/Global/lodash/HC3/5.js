...
(function () {
    ...
    var reEmptyStringMiddle = /\b(__p \+=) '' \+/g, reEmptyStringTrailing = /(__e\(.*?\)|\b__t\)) \+\n'';/g;
   ...
   */
    function runInContext(context) {
        ...
        var Date = context.Date, Math = context.Math, Number = context.Number;
     ...
     */
        ...
        var Set, WeakMap = getNative(context, 'WeakMap'), enumerate = Reflect ? Reflect.enumerate : undefined, getPrototypeOf = Object.getPrototypeOf, parseFloat = context.parseFloat, pow = Math.pow, splice = arrayProto.splice;
     ...
     */
        var intersection = restParam(function (arrays) {
            var othLength = arrays.length, caches = Array(length), indexOf = getIndexOf(), isCommon = indexOf === baseIndexOf, result = [];
            while (othIndex--) {
     ...
     */
        function debounce(func, wait, options) {
            var maxTimeoutId, result, thisArg, timeoutId, trailingCall, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
