...
(function () {
    ...
    var argsTag = '[object Arguments]', arrayTag = '[object Array]', boolTag = '[object Boolean]', dateTag = '[object Date]', errorTag = '[object Error]', funcTag = '[object Function]', mapTag = '[object Map]', numberTag = '[object Number]', objectTag = '[object Object]', regexpTag = '[object RegExp]', stringTag = '[object String]', weakMapTag = '[object WeakMap]';
    var arrayBufferTag = '[object ArrayBuffer]', float32Tag = '[object Float32Array]', float64Tag = '[object Float64Array]', int8Tag = '[object Int8Array]', int16Tag = '[object Int16Array]', int32Tag = '[object Int32Array]', uint8Tag = '[object Uint8Array]', uint8ClampedTag = '[object Uint8ClampedArray]', uint16Tag = '[object Uint16Array]', uint32Tag = '[object Uint32Array]';
    /** Used to match empty string literals in compiled template source. */
    var reEmptyStringLeading = /\b__p \+= '';/g, reEmptyStringTrailing = /(__e\(.*?\)|\b__t\)) \+\n'';/g;
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Date = context.Date, Error = context.Error, Math = context.Math, Number = context.Number, Object = context.Object, String = context.String, TypeError = context.TypeError;
     ...
     */
        ...
        var ArrayBuffer = context.ArrayBuffer, clearTimeout = context.clearTimeout, enumerate = Reflect ? Reflect.enumerate : undefined, getPrototypeOf = Object.getPrototypeOf, parseFloat = context.parseFloat, pow = Math.pow, propertyIsEnumerable = objectProto.propertyIsEnumerable, splice = arrayProto.splice;
        ...
        function createHybridWrapper(func, bitmask, thisArg, partials, holders, partialsRight, holdersRight, argPos, ary, arity) {
            ...
            function wrapper() {
                ...
                if (isCurry || isCurryRight) {
                    var placeholder, argsHolders = replaceHolders(args, placeholder);
     ...
     */
        function getFuncName(func) {
            var result = func.name + '', array, length = array ? array.length : 0;
            while (length--) {
            }
            return result;
        }
     ...
     */
        function getMatchData(object) {
            var result = pairs(object), length;
            while (length--) {
            }
            return result;
        }
     ...
     */
        function mergeData(data, source) {
            ...
            if (value) {
                ...
                data[6] = partials ? replaceHolders(PLACEHOLDER) : copyArray(source[6]);
            }
            ...
            if (srcBitmask & ARY_FLAG) {
                data[8] = data[8] == null ? source[8] : nativeMin();
            }
     ...
     */
        var invoke = restParam(function (collection, path, args) {
            var index = -1, isFunc = typeof path == 'function', isProp, result = isArrayLike(collection) ? Array() : [];
     ...
     */
        function debounce(func, wait, options) {
            var args, maxTimeoutId, result, thisArg, timeoutId, trailingCall, lastCalled = 0, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
