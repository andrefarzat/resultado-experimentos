...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Date = context.Date, Error = context.Error, Number = context.Number, RegExp = context.RegExp, String = context.String;
     ...
     */
        ...
        var ArrayBuffer = context.ArrayBuffer, Reflect, Set, clearTimeout = context.clearTimeout, enumerate = Reflect ? Reflect.enumerate : undefined, getPrototypeOf = Object.getPrototypeOf, parseFloat = context.parseFloat, pow = Math.pow, propertyIsEnumerable = objectProto.propertyIsEnumerable, splice = arrayProto.splice;
     ...
     */
        function debounce(func, wait, options) {
            var maxTimeoutId, result, stamp, thisArg, timeoutId, trailingCall, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
