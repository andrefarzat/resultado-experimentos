...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Date = context.Date, Error = context.Error, Function = context.Function, Number = context.Number, Object = context.Object;
     ...
     */
        var intersection = restParam(function (arrays) {
            var othLength = arrays.length, othIndex = othLength, indexOf = getIndexOf(), result = [];
            while (othIndex--) {
