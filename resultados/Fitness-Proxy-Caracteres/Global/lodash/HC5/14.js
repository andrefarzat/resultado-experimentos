...
(function () {
    ...
    var reEscapedHtml = /&(?:amp|lt|gt|quot|#39|#96);/g, reUnescapedHtml = /[&<>"'`]/g, reHasEscapedHtml = RegExp(reEscapedHtml.source), reHasUnescapedHtml = RegExp();
        ...
        function createCtorWrapper(Ctor) {
            return function () {
                ...
                case 4:
                    return new Ctor(args[0]);
                case 5:
                    return new Ctor(args[4]);
                case 6:
                    return new Ctor(args[0], args[1], args[5]);
                case 7:
     ...
     */
        function mergeData(data, source) {
            ...
            if (value) {
                ...
                data[4] = partials ? replaceHolders(PLACEHOLDER) : copyArray(source[4]);
            }
