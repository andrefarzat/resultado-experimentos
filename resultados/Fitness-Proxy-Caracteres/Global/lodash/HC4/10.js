...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Function = context.Function, Math = context.Math, Number = context.Number, RegExp = context.RegExp, String = context.String, TypeError = context.TypeError;
     ...
     */
        ...
        var Uint8Array = context.Uint8Array, enumerate = Reflect ? Reflect.enumerate : undefined, getPrototypeOf = Object.getPrototypeOf, parseFloat = context.parseFloat, pow = Math.pow, setTimeout = context.setTimeout, splice = arrayProto.splice;
