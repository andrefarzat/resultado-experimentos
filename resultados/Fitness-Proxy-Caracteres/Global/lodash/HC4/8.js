...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Date = context.Date, Function = context.Function, Math = context.Math, Object = context.Object, String = context.String, TypeError = context.TypeError;
     ...
     */
        ...
        var ArrayBuffer = context.ArrayBuffer, Uint8Array = context.Uint8Array, WeakMap = getNative(context, 'WeakMap'), clearTimeout = context.clearTimeout, enumerate = Reflect ? Reflect.enumerate : undefined, getPrototypeOf = Object.getPrototypeOf, pow = Math.pow, propertyIsEnumerable = objectProto.propertyIsEnumerable, setTimeout = context.setTimeout, splice = arrayProto.splice;
