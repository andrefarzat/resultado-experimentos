...
(function () {
   ...
   */
     ...
     */
        ...
        var Set, Uint8Array = context.Uint8Array, enumerate = Reflect ? Reflect.enumerate : undefined, getPrototypeOf = Object.getPrototypeOf, pow = Math.pow, setTimeout = context.setTimeout, splice = arrayProto.splice;
     ...
     */
        function debounce(func, wait, options) {
            var maxTimeoutId, result, stamp, timeoutId, trailingCall, leading = false, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
