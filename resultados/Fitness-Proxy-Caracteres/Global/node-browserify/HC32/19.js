...
function Browserify(files, opts) {
    ...
    self._filterTransform = function () {
...
Browserify.prototype.require = function (file, opts) {
    ...
    if (!opts)
        opts = {};
    var basedir = defined(self._options.basedir, process.cwd());
...
Browserify.prototype.external = function (file) {
    ...
    var basedir = defined(process.cwd());
...
Browserify.prototype.transform = function (tr, opts) {
    ...
    if (!opts)
        opts = {};
    var basedir = defined(this._options.basedir, process.cwd());
...
Browserify.prototype.plugin = function (p, opts) {
    var basedir = defined(this._options.basedir);
