...
function compileBody(str, options) {
    ...
    var ast = load.string(str, {
        ...
        parse: function (tokens, options) {
            ...
            return applyPlugins(applyPlugins(parse(tokens, parseOptions), options, plugins, 'postParse'), options, plugins);
        },
        resolve: function (filename, source, loadOptions) {
            var replacementFunc = findReplacementFunc();
        ...
        read: function (filename) {
            ...
            if (replacementFunc) {
                contents = replacementFunc(filename);
            } else {
