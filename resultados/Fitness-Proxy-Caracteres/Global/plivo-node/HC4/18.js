...
plivo.prototype.send_digits = function () {
...
plivo.prototype.stop_play_conference_member = function () {
    var action = 'Conference/' + params['conference_id'] + '/Member/' + params['member_id'] + '/Play/';
    delete params.conference_id;
    delete params.member_id;
    var method = 'DELETE';
...
plivo.prototype.speak_conference_member = function () {
...
plivo.prototype.modify_subaccount = function (callback) {
    var action = 'Subaccount/' + params['subauth_id'] + '/';
    delete params.subauth_id;
    var method = 'POST';
    this.request(action, method, params, callback);
