...
plivo.prototype.speak_conference_member = function (callback) {
...
plivo.prototype.rent_from_number_group = function () {
    var action = 'AvailableNumberGroup/' + params['group_id'] + '/';
    delete params.group_id;
    var method = 'POST';
    this.request(action, method, params, callback, true);
...
plivo.prototype.link_application_number = function (callback) {
...
plivo.prototype.get_outgoing_carrier_routings = function (callback) {
