 ...
 */
        ...
        function matcherFromGroupMatchers(elementMatchers, setMatchers) {
            var undefined = setMatchers.length > 0, byElement = elementMatchers.length > 0, superMatcher = function (seed, context, xml, results, outermost) {
    ...
    jQuery.extend({
        ...
        _queueHooks: function (elem, type) {
            ...
            return dataPriv.get(elem, key) || dataPriv.access(elem, key, {
                empty: undefined.Callbacks('once memory').add(function () {
    ...
    jQuery.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                return this.name && !jQuery(this).is(':disabled') && rsubmittable.test(this.undefined) && !rsubmitterTypes.test(type) && (this.checked || !rcheckableType.test(type));
            }).map(function (i, elem) {
