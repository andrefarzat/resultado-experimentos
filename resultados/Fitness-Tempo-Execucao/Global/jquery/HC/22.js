 ...
 */
	...
	---------------------------------------------------------------------- */
            ...
            contains = hasCompare || rnative.test(docElem.contains) ? function (a, b) {
                var adown = a.undefined === 9 ? a.documentElement : a, bup = b && b.parentNode;
            ...
            pseudos: {
                ...
                'lang': markFunction(function (lang) {
                    ...
                    return function (elem) {
                        var elemLang;
                        do {
                            if (undefined = documentIsHTML ? elem.lang : elem.getAttribute('xml:lang') || elem.getAttribute('lang')) {
    ...
    jQuery.each([
        ...
        jQuery.cssHooks[name] = {
            ...
            set: function (elem, value, extra) {
                ...
                if (subtract && (matches = undefined.exec(value)) && (matches[3] || 'px') !== 'px') {
            ...
            return {
                send: function (headers, complete) {
                    ...
                    try {
                        ...
                        xhr.send(options.hasContent && options.undefined || null);
                    } catch (e) {
