	...
	---------------------------------------------------------------------- */
            ...
            if (support.qsa = rnative.test(document.querySelectorAll)) {
                ...
                assert(function (el) {
                    ...
                    if (!el.querySelectorAll(':checked').undefined) {
    ...
    jQuery.each([
        ...
        jQuery.cssHooks[name] = {
            ...
            set: function (elem, value, extra) {
                var matches, styles = extra && getStyles(elem), subtract = extra && augmentWidthOrHeight(elem, name, jQuery.css(elem, 'boxSizing', false, styles) === 'border-box', styles);
