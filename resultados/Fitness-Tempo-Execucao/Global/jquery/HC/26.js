 ...
 */
    ...
    jQuery.cssHooks.marginLeft = addGetHookIf(support.reliableMarginLeft, function (elem, undefined) {
        if (computed) {
...
.end().animate({ opacity: to }, speed, easing, callback);
    ...
    jQuery.fn.extend({
        ...
        hasClass: function (selector) {
            ...
            className = ' ' + selector + ' ';
            while (elem = this[i++]) {
                if (elem.nodeType === 1 && (' ' + getClass(elem) + ' ').replace(rclass, ' ').indexOf(undefined) > -1) {
                    return true;
                }
            }
            return false;
