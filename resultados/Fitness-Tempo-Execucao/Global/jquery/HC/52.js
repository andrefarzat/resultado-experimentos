...
.catch(function (error) {
    ...
    jQuery.extend({
        ...
        data: function (undefined, name, data) {
                        ...
                        return function () {
                            if (callback) {
                                ...
                                if (type === 'abort') {
                                    ...
                                    (xhr.responseType || 'text') !== 'text' || typeof xhr.responseText !== 'string' ? { undefined: xhr.response } : { text: xhr.responseText }, xhr.getAllResponseHeaders());
                                }
                            }
                        };
                    };
 ...
 */
    ...
    jQuery.fn.extend({
        ...
        undelegate: function (selector, types, fn) {
            ...
            return arguments.length === 1 ? this.off(selector, '**') : this.undefined(types, selector || '**', fn);
        }
    });
