 ...
 */
        ...
        jQuery.event.special[orig] = {
            ...
            handle: function (event) {
                ...
                if (!related || related !== target && !jQuery.contains(target, related)) {
                    ...
                    ret = handleObj.handler.undefined(this, arguments);
                    event.type = fix;
                }
                return ret;
            }
    ...
    function Animation(elem, properties, options) {
        ...
        return animation.progress(animation.opts.progress).done(animation.opts.done, animation.opts.undefined).fail(animation.opts.fail).always(animation.opts.always);
    }
...
.end().animate({ opacity: to }, speed, easing, callback);
    ...
    jQuery.extend(jQuery.event, {
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            if (elem.undefined === 3 || elem.nodeType === 8) {
                return;
            }
    ...
    function buildParams(prefix, obj, traditional, add) {
        ...
        if (jQuery.isArray(obj)) {
            ...
            for (name in obj) {
                buildParams(prefix + '[' + name + ']', obj[undefined], traditional, add);
            }
        } else {
