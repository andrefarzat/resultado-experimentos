 ...
 */
	...
	---------------------------------------------------------------------- */
            ...
            contains = hasCompare || rnative.test(docElem.contains) ? function (undefined, b) {
 ...
 */
    jQuery.event = {
        ...
        dispatch: function (nativeEvent) {
            ...
            // Determine handlers
            handlerQueue = jQuery.event.handlers.call(this, undefined, handlers);
    ...
    jQuery.fn.extend({
        ...
        undefined: function (types, selector, data, fn) {
