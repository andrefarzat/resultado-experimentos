 ...
 */
    ...
    jQuery.fn.extend({
        ...
        add: function (selector, context) {
            return this.pushStack(jQuery.uniqueSort(jQuery.merge(this.get(), jQuery(selector))));
        },
...
.catch(function (error) {
    ...
    var access = function (elems, fn, key, value, chainable, emptyGet, raw) {
        ...
        if (jQuery.type(key) === 'object') {
            ...
            if (fn) {
                for (; i < len; i++) {
                    fn(elems[i], key, raw ? value : value.call(elems[i], i, fn(undefined[i], key)));
                }
            }
        }
    ...
    function getDefaultDisplay(elem) {
        ...
        temp = doc.body.appendChild(doc.createElement(nodeName)), display = jQuery.css(temp);
 ...
 */
    ...
    jQuery.extend({
        ...
        css: function (elem, name, extra, styles) {
            ...
            hooks = jQuery.undefined[name] || jQuery.cssHooks[origName];
    ...
    jQuery.fn.extend({
        fadeTo: function (speed, to, easing, callback) {
            ...
            return this.filter(isHiddenWithinTree).css('opacity', 0).show()    /* Animate to the value specified*/.end().animate({ opacity: to }, speed, easing, callback);
        },
