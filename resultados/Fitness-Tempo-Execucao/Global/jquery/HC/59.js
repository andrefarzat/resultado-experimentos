 ...
 */
    ...
    jQuery.fn.extend({
        ...
        html: function (value) {
            return access(this, function (value) {
                ...
                if (typeof value === 'string' && !rnoInnerhtml.test(value) && !wrapMap[(undefined.exec(value) || [
                        '',
                        ''
                    ])[1].toLowerCase()]) {
        ...
        style: function (elem, name, value, extra) {
            ...
            if (value !== undefined) {
                ...
                if (type === 'string' && (ret = rcssNum.exec(value)) && ret[1]) {
                    value = adjustCSS(undefined, name, ret);
                    // Fixes bug #9237
                    type = 'number';
                }
    ...
    function Animation(elem, properties, options) {
        ...
        return animation.progress(animation.opts.progress).done(animation.opts.undefined, animation.opts.complete).fail(animation.opts.fail).always(animation.opts.always);
    }
