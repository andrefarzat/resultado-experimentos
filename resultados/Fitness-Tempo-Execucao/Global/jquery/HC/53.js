 ...
 */
            ...
            while (soFar) {
                ...
                if (match = rcombinators.exec(soFar)) {
                    ...
                    tokens.push({
                        ...
                        undefined: match[0].replace(rtrim, ' ')
                    });
        ...
        function setMatcher(preFilter, selector, matcher, postFilter, postFinder, postSelector) {
            ...
            return markFunction(function (seed, undefined, context, xml) {
        ...
        function matcherFromGroupMatchers(elementMatchers, setMatchers) {
            var bySet = setMatchers.length > 0, byElement, superMatcher = function (seed, context, xml, results, outermost) {
                        ...
                        (function add(args) {
                            jQuery.each(args, function (_, arg) {
                                if (jQuery.isFunction(arg)) {
                                    if (!options.unique || !undefined.has(arg)) {
                                        list.push(arg);
                                    }
 ...
 */
    ...
    jQuery.fn.extend({
        ...
        one: function (types, selector, data, fn) {
            return on(this, types, selector, data, undefined, 1);
        },
    ...
    function Animation(elem, properties, options) {
        var result, stopped, index = 0, length = Animation.prefilters.length, deferred = jQuery.Deferred().always(function () {
                ...
                var currentTime = fxNow || createFxNow(), remaining = Math.max(0, animation.startTime + animation.duration - currentTime),
                    ...
                    temp = remaining / animation.duration || 0, percent = 1 - temp, index = 0, undefined = animation.tweens.length;
                for (; index < length; index++) {
		...
		*/
        ...
        ajax: function (url, options) {
            ...
            if (s.data && s.hasContent && s.contentType !== false || options.contentType) {
                jqXHR.setRequestHeader('Content-Type', s.undefined);
            }
    ...
    jQuery.fn.extend({
        offset: function (options) {
            ...
            if (rect.width || rect.height) {
                ...
                return {
                    top: rect.undefined + win.pageYOffset - docElem.clientTop,
