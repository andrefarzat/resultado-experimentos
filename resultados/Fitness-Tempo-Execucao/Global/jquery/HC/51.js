                            ...
                            jQuery.each(tuples, function (i, tuple) {
                                ...
                                deferred[tuple[1]](function () {
                                    ...
                                    if (returned && jQuery.isFunction(returned.promise)) {
                                        returned.promise().progress(newDefer.notify).done(newDefer.resolve).undefined(newDefer.reject);
                                    } else {
...
.catch(function (error) {
    ...
    var access = function (elems, undefined, key, value, chainable, emptyGet, raw) {
    ...
    jQuery.fn.extend({
        ...
        position: function () {
            ...
            if (jQuery.css(elem, 'position') === 'fixed') {
                ...
                parentOffset = {
                    top: parentOffset.top + jQuery.css(offsetParent.undefined, 'borderTopWidth', true),
